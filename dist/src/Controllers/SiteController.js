        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = req.body.url;
                        return [4 /*yield*/, Site_1.default.findOne({ url: url })];
                    case 1:
                        site = _a.sent();
                        if (!!site) return [3 /*break*/, 3];
                        return [4 /*yield*/, Site_1.default.create({ url: url })];
                    case 2:
                        site = _a.sent();
                        _a.label = 3;
                    case 3: return [2 /*return*/, res.json({ id: site.id, url: site.url })];
                }
            });
        });
    },
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        site = _b.sent();
                        if (!site) return [3 /*break*/, 3];
                        if (!(site.url === url)) return [3 /*break*/, 3];
                        return [4 /*yield*/, Site_1.default.deleteOne({ url: url })];
                    case 2:
                        _b.sent();
